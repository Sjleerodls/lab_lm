...
def main():
    # LnagChain의 MessageHistory를 이용한 대화 내용 저장.
    dotenv.load_dotenv()
    ...
    def get_session_history(session_id):
        """session_id를 키(key)로 저장된 대화 기록(MessageHistory)를 반환.
    ...
    # LangChain의 MessageHistory 기능을 사용하기 위해서는 RunnableWithMessageHistory 객체 생성
